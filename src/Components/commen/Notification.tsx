                                ...
                                {hasControlAccess && (
                                    <div className="flex rounded-xl border border-red-700/30 bg-red-900/50 p-1">
                                        <button
                                            ...
                                            className={`rounded-lg p-2 transition-all ${activeSubTab === "admit"
                                        ...
                                        <button
                                            ...
                                            className={`rounded-lg p-2 transition-all ${activeSubTab === "dept"
                                                    ? "bg-white text-red-800 shadow-sm"
                                                    : "text-amber-100/60"
                                                }`}
                                        >
                        ...
                        <div className="flex w-full items-center justify-between gap-2 border-b border-gray-100 bg-white px-3 py-3 shadow-xs sm:px-4">
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className={`flex items-center gap-1.5 rounded-xl border px-3 py-2 text-xs font-black uppercase tracking-wider transition-all sm:px-4 ${timeFilter === "hour"
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-1.5 rounded-xl border px-3 py-2 text-xs font-black uppercase tracking-wider transition-all sm:px-4 ${timeFilter === "week"
                                            ? "border-red-800 bg-red-50 text-red-800 shadow-xs"
                                            : "border-transparent bg-gray-50 text-gray-500 hover:bg-gray-100"
                                        }`}
                                >
