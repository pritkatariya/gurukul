...
export default function AdmitRequestGurukulArt() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const response = await fetch(`${API_URL}/gurukul-art/create-request`, {
                method: 'POST',
                body: dataToSend
            });
            ...
            if (response.ok && data.success) {
                toast.success(`Gurukul Art Admit request sent successfully! 🚀`);
        ...
        <div className="w-full flex flex-col items-center p-4 md:p-8 select-none">
            <div className="text-center mb-8">
                <h1 className="text-3xl font-black text-red-950 uppercase tracking-tight">
                    Gurukul Art Admit Application
                </h1>
                <p className="text-gray-500 text-sm mt-1">
                    Submit student verification profile directly to Gurukul Art Control Panel
                </p>
